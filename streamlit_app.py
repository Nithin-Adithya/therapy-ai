...
def main():
    ...
    /* Remove this redundant section - we have better mobile CSS above */
    </style>
    """, unsafe_allow_html=True)
    ...
    # JavaScript to detect screen width and hide sidebar on mobile
    # (Removing this since we have better code at the start of the app)
